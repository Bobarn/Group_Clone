...
export default function ProductDetailsPage() {
        ...
        {categoryProducts?.map((item) => (
          ...
          >
            ...
            <div id="suggested-info">
              ...
              {item.free_shipping && (
                <p id="free-shipping-banner">Free shipping!</p>
              )}
            </div>
          </div>
        ))}
  ...
  return (
    <div id="product-details-page">
          ...
          <div className="review-area">
            <Carousel className="Carousel Images">
              {product?.images.map((image) => {
                return (
                  <div className="Carousel-image" key={image?.id}>
                    <div
                    ...
                    <img
                      ...
                      onError={(e) =>
                        (e.target.src =
                          "https://www.analyticdesign.com/wp-content/uploads/2018/07/unnamed-574x675.gif")
                      }
                      alt="product image"
                    />
                  </div>
            ...
            <span className="reviews-stats">
              ...
              <StarRatings
                className="stat"
                rating={
                  product?.star_rating === null ? 0 : product?.star_rating
                }
      ...
      <h2 id="suggestions-title">Interested in More Like This?</h2>
